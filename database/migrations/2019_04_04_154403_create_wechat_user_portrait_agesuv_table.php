...
class CreateWechatUserPortraitAgesuvTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wechat_user_portrait_agesuv', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('wechat_user_portrait_agesuv');
    }
}
