...
class CreateMonthlyVisitTrendTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('monthly_visit_trend', function (Blueprint $table) {
            $table->increments('id');
            $table->string('gh_id', 40)->comment('小程序id');
            $table->string('ref_date',6)->comment('日期');
    ...
    {
        Schema::dropIfExists('monthly_visit_trend');
    }
}
