...
class UserPortraitAgesController extends Controller
{
    ...
    {
        $grid = new Grid(new UserPortraitAges);
...
//                ->groupBy('gender')->get()->pluck('count', 'gender')->toArray();
    ...
    {
        $show = new Show(UserPortraitAges::findOrFail($id));
    ...
    {
        $form = new Form(new UserPortraitAges);
