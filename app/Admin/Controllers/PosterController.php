...
class PosterController extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->column('bg_image','背景图片')->display(function($bg_image){
            ...
            return '<img class="bg" src="'.storage_path('app/public/images').$bg_image.'" height="50px" width="50px"> ';
        });;
           ...
           // $url=Storage::disk('qiniu')->url($code_image);
            ...
            foreach ($code_images->chunk(3) as $images){
                ...
                foreach ($images as $image){
                    $div.='<img src="'.storage_path('app/public/images').$image.'" height="50px" width="50px">  ';
                }
                $div.='<hr>';
            }
            return $div;
